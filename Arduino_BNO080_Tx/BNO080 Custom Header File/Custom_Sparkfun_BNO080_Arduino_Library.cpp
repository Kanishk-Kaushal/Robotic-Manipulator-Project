/*
  This is a custom built library written for the BNO080
  Keeping in mind that the user would want want to Transmit these values through USART
  
  Programmer: Kanishk Kaushal & Priya 
  
*/

#include "Custom_SparkFun_BNO080_Arduino_Library.h"
